...
public final class CruSonPlugin extends SonarPlugin {
    ...
    public List getExtensions() {
        return ImmutableList
                .of(PropertyDefinition.builder(CRUSON_ENABLED)
                        ...
                        .defaultValue(Boolean.FALSE.toString()).index(0)
                        .build(),
                        PropertyDefinition
                                .builder(CRUSON_HOST_URL)
                                .name("Crucible host url")
                                .description(
                                        "Crucible host url like http://crucible:8080")
                                .onlyOnQualifiers(Qualifiers.PROJECT)
                                .category(CoreProperties.CATEGORY_GENERAL)
                                .subCategory(SUBCATEGORY_CRUCIBLE)
                        ...
                        PropertyDefinition.builder(CRUSON_PROJECT)
                                ...
                                .category(CoreProperties.CATEGORY_GENERAL)
                                .subCategory(SUBCATEGORY_CRUCIBLE)
                                .type(PropertyType.STRING).index(4).build(),
                        ...
                        PropertyDefinition
                                .builder(CRUSON_SEVERITY)
                                .name("Crucible minimum severity")
                                .description(
                                        "Crucible minimum severity. May be one of INFO, MINOR, MAJOR, CRITICAL, BLOCKER")
                                .onlyOnQualifiers(Qualifiers.PROJECT)
                                .category(CoreProperties.CATEGORY_GENERAL)
                                .subCategory(SUBCATEGORY_CRUCIBLE)
                                .type(PropertyType.SINGLE_SELECT_LIST)
                                .options("INFO", "MINOR", "MAJOR", "CRITICAL",
                                        "BLOCKER").defaultValue(Severity.MINOR)
                                .index(6).build(),
                        NewIssuesNotificationDispatcher.class,
                        CrucibleNotificationChannel.class,
                        HttpDownloadImpl.class, CrucibleApiImpl.class,
